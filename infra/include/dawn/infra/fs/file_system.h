...
std::uintmax_t file_size(const std::filesystem::path& path, std::string* error = nullptr);
bool write_text_file(const std::filesystem::path& path, const std::string& text, std::string* error = nullptr);
bool write_binary_file(const std::filesystem::path& path, const std::string& data, std::string* error = nullptr);
bool append_binary_file(const std::filesystem::path& path, const std::string& data, std::string* error = nullptr);
